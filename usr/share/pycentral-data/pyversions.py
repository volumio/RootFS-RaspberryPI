...
class PyCentralEmptyValueError(ValueError):
    """Python Central Value Error"""
    pass
...
def parse_versions(vstring, add_exact=False):
    # Fix packages which were built with the broken dh_pycentral 0.5.50ubuntu1.
    if vstring.lower().startswith("python:versions="):
        vstring = string.split(vstring, "=", maxsplit=1)[1]
    import operator
